...
def calc_wps_domain_info(wps_file):
    ...
    #length_x = np.zeros((1, 1))
    #length_y = np.zeros((1, 1))
...
ax1.add_patch(mpl.patches.Rectangle((corner_x4[0], corner_y4[0]),  length_x[3], length_y[3],
                                    fill=None, lw=3, edgecolor='green', zorder=10))
ax1.text(corner_x4[0]+length_x[3]*0.1, corner_y4[0]+length_y[3]*0.8, 'D04',
         fontproperties=font0, size=15, color='green', zorder=10)
...
ax1.set_title('Anidamiento WRF-Qollpana', size=20)
...
cb1.set_ticklabels(['0','1500','3000', '4500', '6000'])
cbar_ax.tick_params(labelsize=12)
cbar_ax.text(1.9, -0.01, 'm', size=12)

plt.savefig("Anidamiento QollpanaTest.png")
plt.show()
